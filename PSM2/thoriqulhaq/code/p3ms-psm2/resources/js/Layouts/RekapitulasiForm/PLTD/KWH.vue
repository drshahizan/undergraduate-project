<template>
    <div class="flex w-full h-full px-[34px] py-[40px] gap-[61px]">
        <div class="flex-1">
            <h2 class="mb-[42px] tracking-[0.1em] text-white text-[28px] font-semibold">ENGINE MODULE</h2>
            <RekapitulasiInput 
                value="MESIN 1" 
                :model="{
                    name: 'mesin_1_th',
        ...
        <div class="flex-1">
            <h2 class="mb-[42px] tracking-[0.1em] text-white text-[28px] font-semibold">KWH METER PEMBANDING</h2>
            <RekapitulasiInput 
                value="MESIN 1" 
                :model="{
                    name: 'mesin_1_mp3',
