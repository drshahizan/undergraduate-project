    ...
    <MainLayoutAdmin sideBar="2">
        <div class="flex justify-between items-center mb-[2rem]">
            <div class="flex flex-col">
                ...
                <p class="text-[12px]">Pengguna Admin</p>
            </div>
            <div>
                <Link href="/admin/kelola-akun/admin/input" class="py-[0.5rem] px-[1rem] flex justify-center items-center bg-[#14A3B8] rounded-[0.5rem] drop-shadow-[0px_12px_24px_rgba(0,0,0,0.04)]">
        ...
        <div class="bg-white flex-1 rounded-[2rem] p-[0.5rem] relative">
            <div class="card h-full">
                    <DataTable removableSort v-model:filters="filters" :value="data" paginator :rows="10" dataKey="id" :loading="loading" class="bg-white rounded-[1rem] flex flex-col h-full" headerClass="bg-white border-none" tableClass="border-none"
                            :globalFilterFields="['name']">
                        <template #header>
                            <div class="flex justify-end">
                                <span class="p-input-icon-right">
                                    <InputText v-model="filters['global'].value" placeholder="Cari Admin" class="p-inputtext-sm border-[1.5px] border-[#F8F8F9] bg-[#F8F8F9] rounded-[0.5rem] h-[42px]"/>
                        ...
                        <Column sortable field="id" header="ID" style="min-width: 3rem">
                            <template #body="{ data }">
                                {{ data.id }}
                            </template>
                        </Column>
                        ...
                        <Column sortable field="created_at" header="Tanggal" style="width: 5rem">
                            <template #body="{ data }">
                        ...
                        <Column field="aksi" header="Aksi" style="width: 9rem">
                            <template #body="{ data }">
                                <div class="flex justify-center items-center gap-[1rem]">
                                    <Link :href="'/admin/kelola-akun/admin/edit/' + data.id">
                ...
                <div class="w-[30rem] h-[15rem] bg-white rounded-[1.5rem] drop-shadow-[0px_12px_24px_rgba(0,0,0,0.04)] flex flex-col">
                    ...
                    <div class="flex justify-end items-center px-[2rem] py-[1.25rem] gap-[1rem]">
                        ...
                        <Link :href="'/admin/kelola-akun/admin/delete/' + idHapusData" class="py-[0.5rem] px-[1rem] flex justify-center items-center bg-[#EF406C] rounded-[0.5rem] drop-shadow-[0px_12px_24px_rgba(0,0,0,0.04)]">
