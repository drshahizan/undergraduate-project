...
# Initialize an empty list to store accumulated rainfall data
accum = []
...
for year in tahun:
    ...
    for p in location:
        ...
        # Initialize a list to store rainfall data for the year
        rainfall_data = [year]
...
csv_file_path_2 = r'C:\Users\MSI\Documents\PSM\TRAINING\TRAINING\Code\rainfall_data_melaka.csv'
