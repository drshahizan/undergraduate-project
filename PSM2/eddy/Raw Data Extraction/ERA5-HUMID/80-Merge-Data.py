...
# Initialize an empty list to store accumulated humid data
accum = []
...
for year in tahun:
    ...
    for p in location:
        ...
        # Initialize a list to store humidity data for the year
        humid_data = [year]
...
csv_file_path_2 = r'C:\Users\MSI\Documents\PSM\TRAINING\TRAINING\Code\humidity_data_melaka.csv'
