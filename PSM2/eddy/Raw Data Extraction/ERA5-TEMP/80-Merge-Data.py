...
# Initialize an empty list to store accumulated temperature data
accum = []
    ...
    for p in location:
        ...
        for month in range(1, 13):
            ...
            if os.path.exists(file_path):
                ...
                temperature_data.append(data[5])
            else:
...
csv_file_path_2 = r'C:\Users\MSI\Documents\PSM\TRAINING\TRAINING\Code\temperature_data_melaka.csv'
