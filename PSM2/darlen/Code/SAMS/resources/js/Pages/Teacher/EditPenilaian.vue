<template>
    <TeacherLayout :page-title="'Ubah Penilaian'">
        ...
        <div class="flex-1 ">
            <DataTable class="mx-[2rem]" v-model:filters="filters" paginator :rows="5" :rowsPerPageOptions="[5, 10, 20, 50]"
                ...
                <Column style="min-width: 12rem" header="Aspek">
                    <template #body="">
                        <Dropdown v-model="selectedCity" :options="cities" optionLabel="name" placeholder="Pilih Aspek"
                            class="flex-1 w-[10rem] md:w-8rem mr-6" />
                    </template>
                </Column>
                <Column style="min-width: 12rem" header="Action">
                    <template #body="">
                        <Button class="mr-3" type="button" label="Ubah" severity="success" />
                    </template>
                </Column>
